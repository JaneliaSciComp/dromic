function result = threshold_crossings_with_refractory_period(x, threshold, crossing_sign, refractory_scan_count, x_previous, scans_since_last_event)
    if crossing_sign >= 0 ,
    ...
    result = impose_refractory_period(is_desired_edge, refractory_scan_count, scans_since_last_event) ;
end
